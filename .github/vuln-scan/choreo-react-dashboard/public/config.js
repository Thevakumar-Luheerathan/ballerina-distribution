...
//
// This checked-in copy is only the local-dev default, pointing at choreo-dashboard's default port
// (see ../../choreo-dashboard/main.bal's `configurable int port = 9090`).
window.config = {
