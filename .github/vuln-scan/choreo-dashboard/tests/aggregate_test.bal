// Exercises aggregate.bal against the shared sample fixture (.github/vuln-scan/fixtures/
...
// removed when the dashboard UI moved to the separate React app - see choreo-react-dashboard/.
